...
export default function Cita({ citas }: CitaProps) {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="mb-6 md:p-15 p-10">
                <div className="mb-4 flex items-center justify-between">
                    <h1 className="text-2xl font-semibold mb-6">Listado de Citas</h1>
                    <Link href={route('cms.citas.create')}>
                        <button
                            type="button"
                ...
                <DataTable items={citas} resourceRoute="cms.citas" />
            </div>
        </AppLayout>
    );
}
