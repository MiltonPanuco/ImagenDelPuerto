        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="md:p-15 p-10 bg-white dark:bg-neutral-800">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    {/* Nombre del Servicio */}
                    <div>
                        <label className="block mb-2 font-medium text-sm text-gray-700 dark:text-neutral-200">Nombre del Servicio</label>
                        <input
                            type="text"
                        ...
                        />
                        {errors.servicio && <div className="text-red-500 dark:text-red-400 text-sm mt-1">{errors.servicio}</div>}
                    </div>
                    ...
                    <div>
                        ...
                        {errors.icon && <div className="text-red-500 dark:text-red-400 text-sm mt-1">{errors.icon}</div>}
                    </div>
                    ...
                    {/* Categoría */}
                    <div>
                        <label className="block mb-2 font-medium text-sm text-gray-700 dark:text-neutral-200">Categoría</label>
                        <input
                            type="text"
                            className="w-full border rounded px-3 py-2 bg-gray-50 dark:bg-neutral-700 border-gray-300 dark:border-neutral-600 text-gray-900 dark:text-neutral-100 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400"
                        ...
                        />
                        {errors.categoria && <div className="text-red-500 dark:text-red-400 text-sm mt-1">{errors.categoria}</div>}
                    </div>
