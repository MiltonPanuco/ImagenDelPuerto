...
const breadcrumbs: BreadcrumbItem[] = [{ title: 'Gestionar Mision' }];
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="md:p-15 p-10 bg-white dark:bg-neutral-800">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    {/* Nombre de la Misión/Visión */}
                    <div>
                        <label className="block mb-2 font-medium text-sm text-gray-700 dark:text-neutral-200">Nombre de la Misión/Visión</label>
                        <input
                            type="text"
