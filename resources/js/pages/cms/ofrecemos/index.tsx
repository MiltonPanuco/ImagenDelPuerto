...
export default function Ofrecemos({ ofrecemos }: Ofrecemos) {

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Ofrecemos" />

            <div className="mb-6 md:p-15 p-10">
                <div className="mb-4 flex items-center justify-between">
                    <h1 className="text-2xl font-semibold mb-6">Listado de Ofrecemos</h1>
                    <Link href={route('cms.ofrecemos.create')}>
                        <button
                            type="button"
