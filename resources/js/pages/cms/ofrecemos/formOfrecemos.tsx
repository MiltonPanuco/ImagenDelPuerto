            ...
            <div className="md:p-15 p-10 bg-white dark:bg-neutral-800">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                {(() => {
                                    ...
                                    return (
                                        <div className="flex items-center space-x-2">
                                            <SelectedIcon className={`w-8 h-8 text-${color}-500 transition`} />
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        />
                        <label htmlFor="activo" className="text-sm font-medium text-gray-700 dark:text-neutral-200">Activo</label>
                    </div>
