...
export default function Index({ sociales }: Props) {
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="mb-6 md:p-15 p-10">
                <div className="mb-4 flex items-center justify-between">
                    <h1 className="text-2xl font-semibold mb-6">Listado de Redes Sociales</h1>

                    <Link href={route('cms.sociales.create')}>
                        <button
                            type="button"
                ...
                <DataTable items={sociales} resourceRoute="cms.sociales" />
            </div>
        </AppLayout>
    );
}