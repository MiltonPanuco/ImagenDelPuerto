         ...
         <Dialog open={open} onClose={onClose}>
            <DialogContent showCloseButton={false}>
                    <DialogTitle className="flex items-center justify-between">
                        ...
                        <button
                            onClick={onClose}
                            className="ml-auto text-gray-500 hover:text-gray-700 text-2xl font-bold cursor-pointer"
                            aria-label="Cerrar"
                            type="button"
                        >
                            &times;
                    ...
                    >
                        ...
                        <CardContent className="p-6 sm:p-8 text-center">
                            ...
                            <h3 className="text-xl sm:text-2xl font-semibold text-slate-900 mb-3 sm:mb-4">{equipo.titulo}</h3>
