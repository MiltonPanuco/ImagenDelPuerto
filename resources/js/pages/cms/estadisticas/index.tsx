...
export default function Estadisticas({ estadisticas }: Props) {
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="mb-6 md:p-15 p-10">
                <div className="mb-4 flex items-center justify-between">
                    <h1 className="text-2xl font-semibold mb-6">Listado de Estadísticas</h1>
                    <Link href={route('cms.estadisticas.create')}>
                        <button
                            type="button"
                ...
                <DataTable items={estadisticas} resourceRoute="cms.estadisticas" />
            </div>
        </AppLayout>
    );
}
